<%-- 
    Document   : index
    Created on : Oct 6, 2022, 10:59:05 PM
    Author     : Dewmin
--%>
            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="login/indexlogin.html" class="nav__link">Log in|</a></li><i class="material-icons">person_add</i>
        ...
        <div class="slide active" style="background-image: url('images/slide-1.jpg')">
            <div class="container">
                <div class="caption">
                    ...
                    <a href="admin/index.html">Book Now</a>-->
                </div>
            </div>
        </div>
...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
      ...
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="date" placeholder="Enter your number" required>
          </div>
        </div>
        <div class="gender-details">
          ...
          <div class="category">
            ...
            <span class="gender">Roundtrip</span>
          </label>
          <label for="dot-2">
    ...
    <div class="calendar">
        ...
        <footer class="footer section bd-container">
            ...
            <p class="footer__copy">&#169; J.M.B.Ideas All right reserved</p>
        </footer>
